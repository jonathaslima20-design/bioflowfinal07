  ...
  return (
    <footer className="bg-black text-white border-t-2 border-black">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-14 grid md:grid-cols-4 gap-10">
        ...
        <FooterCol title="Empresa" items={['Sobre', 'Blog', 'Contato', 'Carreiras']} />
        <FooterCol title="Legal" items={['Termos', 'Privacidade', 'Cookies', 'DMCA']} />
      </div>
      <div className="border-t-2 border-white/20">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-5 flex flex-col md:flex-row items-center justify-between gap-3 text-xs">
          <span>© 2026 BioFlowzy. Todos os direitos reservados.</span>
          <span>Feito com borda de 2px e sombra de 4px.</span>
        </div>
      </div>
    </footer>
  );
